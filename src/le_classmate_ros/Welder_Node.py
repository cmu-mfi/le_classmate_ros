...
"""
import le_classmate_ros.Welder as Welder
import rospy 
...
class Welder_Node():
    ...
    def __init__(self):
        ...
        self.welder_util = Welder.Welder(server=server_ip)
        ...
        rospy.Service('set_override', Trigger, self.set_override_srv)
    ...
    def set_override_srv(self, request):
        """Service handler to set override value to 100
        
        @param request: Empty Trigger service request
        @return: TriggerResponse with success=True on successful override set
        """
        self.welder_util.set_override(100)
        return TriggerResponse(success=True, message="Override set to 100")
